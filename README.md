...
The Operator values your privacy. This application does not require user registration or account creation. We do not collect, store, track, or share any personal information, device identifiers, or user data. All operations are processed entirely on the user's local device without any external network transmission of personal data (Collection Status: none).
